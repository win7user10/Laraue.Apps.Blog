...
> Это вводная статья цикла о том, как разрабатываются Laraue Boards: решения, компромиссы и ошибки. Разработка ведется итеративно, в каждой статье решается проблема или разрабатывается новая версия приложения. Если интересен сам продукт, а не то, как он сделан, можно открыть [проект](https://msgboard.laraue.com), страницу с его [подробным описанием](../projects/boards) или [документацию](../documentation/laraue-boards).
