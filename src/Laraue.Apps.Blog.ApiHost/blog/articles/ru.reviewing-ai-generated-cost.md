...
description: Современный подход к разработке все больше сводится к тезису - код должен писать ИИ, а разработчик лишь направляет его в нужную сторону и проверяет результаты. А то, что отревьюить сгенерированный код так, чтобы ему довериться, часто дольше, чем написать его самостоятельно, старательно опускается.
type: article
